...
from logistic_sgd import LogisticRegression, load_data_shared
from mlp import HiddenLayer

def evaluate_lenet5(learning_rate=0.1, n_epochs=200,
                    dataset='../data/large_sample/',
    ...
    datasets = load_data_shared(dataset)
    ...
    layer1 = LeNetConvPoolLayer(
        rng,
        input=layer0.output,
        image_shape=(batch_size, nkerns[0], 121, 121),
    ...
    layer2 = LeNetConvPoolLayer(
        rng,
        input=layer1.output,
        image_shape=(batch_size, nkerns[1], 56, 56),
